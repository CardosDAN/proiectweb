                ...
                <div class="col-6 text-right">
                    <div class="mr-auto container">
                        <div style="width: 100%;">
                            ...
                            <div style="margin-left: 5%; height: 25px;">
...
<div class="main">
    ...
    <div class="container marketing" style="margin-top: -0.1px">
        <div class="row">
            <div class="position-relative  border rounded" style=" background:white; width: 27%;">
                <img src="website-menu-07/images/luxury-fruit-basket-6531-dv-p.jpg"
                     style="height:150px; margin-left: -450%"/>
                <div class="col-sm-6 col-md-6 col-xs-6">
                    <div class="thumbnail" style=" width: 300%;">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div class="position-relative  border rounded" style=" background:white; width: 27%;">
                <img src="website-menu-07/images/legume.jpg"
                     style="height:150px; margin-left: -450%"/>
                <div class="col-sm-6 col-md-6 col-xs-6">
                    <div class="thumbnail" style=" width: 300%;">
                        <div class="col-sm-6 col-md-6 col-xs-12">
