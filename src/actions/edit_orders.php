...
// Display status message
                    ...
                    $qry = mysqli_query($con, "select * from anunturi,images where anunturi.id='$id'"); // select query
                                        ...
                                        <div class="center">
                                            <div class="form-input">
                                                <div class="preview">
                                                    ...
                                                    <input type="file" id="file-ip-1" name="file" value="<?php echo $row['image_id'] ?>" accept="image/*" onchange="showPreview(event);">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
